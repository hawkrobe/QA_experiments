...
print(paste0('BF (free beta, questioner): ',
             computeBayesFactor("fullQuestioner_Params")))
print(paste0('BF (free beta, answerer): ',
      computeBayesFactor("fullAnswerer_Params")))
```
...
questionParamPosterior <- qparams.samples %>%
  ggplot(aes(x = value))+
    ...
    theme_bw()
questionParamPosterior
ggsave(file="../../../writing/2016/journal-manuscript/figures/QuestionerParamPosteriors.pdf", questionParamPosterior, width = 6, height = 3)
```
...
aparams.toplot <- filteredAparams[rep(row.names(filteredAparams), filteredAparams$MCMCprob*samples), 1:2] 
...
answererParamPosteriors = ggplot(aparams.toplot, aes(x=value))+
    ...
    theme_bw()
ggsave("../../../writing/2016/journal-manuscript/figures/AnswererParamPosteriors.pdf", answererParamPosteriors, width = 6, height = 3)
```
...
```{r}
generateAnswererPredictiveFit <- function(name) {
...
generateAnswererPredictiveFit('betaZeroAnswerer_Predictives')
generateAnswererPredictiveFit('fullAnswerer_Predictives')
```
