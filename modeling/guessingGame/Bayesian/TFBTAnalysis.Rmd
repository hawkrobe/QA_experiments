...
```{r}
qparams<-read.csv("guessingGame/Bayesian/data/BayesianQuestionerAnalysisParams.csv", sep = ",", row.names = NULL)
samples = 1000
str(qparams)
...
```{r}
qpredictive<-read.csv("guessingGame/Bayesian/BayesianQuestionerAnalysisPredictives.csv", sep = ",", row.names = NULL)
