...
// printERP(questioner(makeQUD("poodle")))
// console.log("for QUD = siamese")
// printERP(questioner(makeQUD("siamese")))
// console.log("for QUD = flower")
// printERP(questioner(makeQUD("flower")))
...
// NOTE: this is an erp sampled from an erp of erps... 
// If you embed this in a pragmatic questioner, it will wash out to a uniform distribution
...
// note: cannot cache with qud input: it's a function
