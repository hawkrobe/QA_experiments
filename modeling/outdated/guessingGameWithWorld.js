...
var questioner = function(qud) {
  Enumerate(function(){
    ...
    var prior = Enumerate(function(){
      // What is the location of the type of object I care about, under my prior?
    ...
    var expectedKL = mean(
      function(){
        ...
        var posterior = Enumerate(function(){
          ...
          // What is the location of the type of object I care about, 
          // under this new distribution on worlds?
          return qud(world);
        });
...
//cmd_print(questioner(makeQUD('dog')));
// console.log("\n")
cmd_print(questioner(makeQUD('siamese')));
// console.log("\n")
