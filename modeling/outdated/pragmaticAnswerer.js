    ...
    var expectedKL = mean(
      function(){
        ...
        var posterior = Enumerate(function(){
          ...
          // Given this answer, how would I update my distribution on
          // the value of the predicate I care about?
...
//print(answerer("dog?", "dalmatian"));
print(pragmaticAnswerer("dog?", "dalmatian"));
