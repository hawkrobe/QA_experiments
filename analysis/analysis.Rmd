...
computeBayesFactor <- function(name, typicality) {
  inputFile <- paste0("../modeling/guessingGame/Bayesian/data/",
                      name, '.csv')
  raw <- read_csv(inputFile) %>% 
...
print(paste0('BF (beta=0, questioner): ',
             computeBayesFactor("answerer_modelComparisonParams", 'none')))
print(paste0('BF (beta=0, answerer): ',
      computeBayesFactor("full_answererParams")))
```