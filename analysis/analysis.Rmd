...
comp.ans = modelComparison("answerer_modelComparisonParams", FALSE) %>% spread(modelType, prob) 
cat('\nBF (beta=0, answerer)', exp(comp.ans$pragmatic - comp.ans$explicit))

comp.quest = modelComparison("questioner_modelComparisonParams", FALSE) %>% spread(modelType, prob) 
