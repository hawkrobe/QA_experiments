...
examinePredictives <- function(name, useTypicality, winningModel) {
  ...
  predictive.plot = (ggplot(predictive, aes(x = MAP, y = empProb))
    ...
    + ggtitle(paste0(QorA, " Posterior Predictive"))
...
```{r}
examinePredictives('questioner_modelComparisonPredictives', useTypicality = T, winningModel = 'explicit')
examinePredictives('questioner_modelComparisonPredictives', useTypicality = T, winningModel = 'pragmatic')
```
