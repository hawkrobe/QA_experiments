...
A primary internal mechanism driving pragmatic behavior in our models is $A_2$'s Bayesian inference about the hidden goal conditioned on the question. 
While the overall success of $A_2$ in predicting answerer behavior in Experiments 1 and 2 provided indirect evidence for this mechanism, the goal belief elicitation step included in the design Experiment 3 provides the opportunity for a more direct test of this mechanism.
...
Just as the answerer's beliefs about the goal shifted as they accumulated more evidence, questioners asked different follow-up questions depending on the answer to their first question.
See Fig. \ref{fig:blocked} for a qualitative view on how dialogue unfolded.
Answerer predictions computed with $\alpha_Q = 100, \alpha_A = 2.5, \beta = .5$ and questioner predictions computed with $\alpha_Q=13, \alpha_A=2.5, \beta = .5$.

\todo[inline]{First report `holistic' model comparison w/ likelihoods; predictives?}

While the primary aim of Experiment 3 was to elucidate qualitative features of extended dialogue, it also provided another opportunity to conduct a formal model comparison over a wide variety of items.
...
\todo[inline]{Next report some qualitative thing just looking at `blocked' trials? like, how does question distribution shift after hearing about blockage?}
