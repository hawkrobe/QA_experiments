...
We examined participants' goal inferences in the \emph{empty} condition, which was designed to compare how the answerer's beliefs about the hidden goal may change over repeated exchanges. 
The first question could provide no information about the hidden goal: the questioner is equally likely to ask about any cell in either case.
In the context of the information revealed in the first exchange, however, the second question ought to license stronger inferences.
We compared responses in these two cases against those collected after the first question of the \emph{pragmatic} condition. 
The pragmatic condition served as a baseline where $A_2$ predicts that sufficient context is already available to make a strong goal inference.
