...
\end{center}
\caption{Empirical answerer responses to ``Which goal do you think your partner has?''  after hearing the $k$th question in different conditions. Error ribbons are bootstrapped 95\% CIs.}
%\vspace{-1cm}
...
These results provide a simple demonstration of how answerers systematically use context to make accurate inferences about their partner's goals, whether that context is provided in the initial common ground or by earlier question-answer exchanges.
