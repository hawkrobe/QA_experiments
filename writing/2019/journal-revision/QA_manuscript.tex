...
\begin{equation}
U_{A_2}(a; q, w) = \alpha_A \sum_{g \in \mathcal{G}} P(g|q) \widehat{P^g_I}(w|\,a) - \beta C(a)
\end{equation}
...
First, because utterances did not differ in cost, we remove the cost term by setting $\beta=0$.
