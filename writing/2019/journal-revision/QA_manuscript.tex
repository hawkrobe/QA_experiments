...
Given this generalization to more structured goal spaces, we can derive model predictions for Experiment 2. 
...
Finally, the answer space $\mathcal{A}$ consisted of any combination of one or two card locations, which evaluate to true in worlds where the card or cards are in the mentioned location and false otherwise.
