...
$Q_2$, on the other hand, recognizes that certain questions may provide better signals about the ultimate goal than others.
...
Experiment 2 was motivated by two primary aims: to provide a stronger evaluation for the questioner models, and to generalize our model to more sophisticated spaces of goals.
To achieve both of these aims, we \dots

Subgoals raises questions about planning which are outside the scope of this paper.
Planning is also key for a general theory of dialogue.
In the next section, we take a first pass by looking at some features of multi-round dialogue that do not require planning.
