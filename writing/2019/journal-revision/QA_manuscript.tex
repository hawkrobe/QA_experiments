...
In Fig. \ref{fig:blocked}, we show a schematic view of how dialogue unfolded in an example trial in the blocked condition.
The questioner was assigned the \emph{row} goal, and 
...
\begin{tabular}{@{}llr@{}}
\toprule
\multirow{2}{*}{answerers} & $A_1$ & -1894 \\ \cmidrule(l){2-3} 
 & $A_2$ & \textbf{-1388} \\ \midrule
\multirow{2}{*}{questioners} & Q1 & -1138  \\ \cmidrule(l){2-3} 
 & Q2 & -1139 \\ \bottomrule
\end{tabular}
\end{center}
...
\begin{figure}[t!]
\begin{center}
\includegraphics[scale = .7]{Exp3/predictives.pdf}
\end{center}
