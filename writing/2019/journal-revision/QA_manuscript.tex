...
However, our account departs from this starting point in two critical ways, motivated by two limitations it faces as a cognitive model of inquiry.
First, how does the answerer know what the decision problem is? 
...
In our view, this assumption undermines the functional conditions motivating inquiry. 
...
We also found that incorporating realistic identifiability priors to interpret definite questions provided a substantially better fit to our data. 

There are two reasons incorporating identifiability into our model is important. 
...
To understand how our empirical identifiability distribution captured this data, consider that a Dalmatian is a far more typical and salient member of the `pet' category than a goldfish \cite{Rosch75}. 
...
In these cases, we expect typicality strongly guides interpretation of the definite article in questions.

Another aspect of our results, which is somewhat orthogonal \dots
