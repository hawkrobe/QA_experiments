...
\title{Questions and answers in dialogue} % Why do you ask? \\ Social cognition and context shape human inquiry
...
In other words, we assume participants use some mixture between the pure uniform and empirical priors but we have uncertainty over the mixture weight.
