...
As in Experiment 1, participants were either assigned the role of questioner or answerer, the questioner was given a private goal, and the answerer was given private information about the world state.
Unlike in Experiment 1, however, each goal was a \emph{set} of multiple objects that must be collected.
More specifically, the questioner was assigned a hand of playing cards to find, which were scattered with other cards around a grid that only the answerer can see.
...
A pragmatic questioner, in turn, ought to be sensitive to which questions best signal the ultimate goal.
