...
After seeing their goal, questioners selected a cell to ask about from a dropdown menu. 
This was sent to a chat box messaging display on the answerer's screen.
In order to elicit goal inferences from answerers, we first asked ``Which goal do you think your partner has?'' and provided three response options: ``rows,'' ``columns,'' or ``not sure.'' 
After clicking one of these options, participants were prompted to give a yes/no answer to the question asked and then chose between ``send more info'' or ``that's all.'' 
If they chose the latter, their yes/no response was immediately sent to the questioner; if they elected to send more information, we showed dropdown menus with all possible cells, allowing for responses like ``no, X is not safe, but Y is.'' 
This extra step made providing additional information somewhat costlier.
