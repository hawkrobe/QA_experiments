...
That is, they assume a question will be preferred if it is expected to be informative for both the subgoal \emph{and} ultimate goal.
...
Given this posterior over the goal tuple $g_{ij}$, we can generalize Equation \ref{eq:A2utility} by assuming the answerer attempts to be informative with respect to each goal in the tuple:
