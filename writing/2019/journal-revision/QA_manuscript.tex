...
This is somewhat different from the context-sensitive literal meanings suggested by \citeA{VanRooy03_QuestioningDecisionProblems}.
As previously discussed, this account argued that the meaning of a question ought to be underspecified and resolved only through the contextual parameter of the questioner's decision problem.
