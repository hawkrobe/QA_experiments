...
It was clear from a basic understanding of the instructions that the questioner needed to ask about the third cell and the answerer ought to reveal it. 
These two practice trials were followed by four random trials, then a scrambled sequence where each participants saw each condition once in each role, interspersed with random trials as fillers.
