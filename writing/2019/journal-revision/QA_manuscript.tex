...
First, it establishes a \emph{joint goal} shared by both participations, thus emphasizing the need for cooperation. 
Second, while preserving the asymmetry in world knowledge between questioner and answerer used in prior work, it \emph{also} explicitly introduces an asymmetry in knowledge about \emph{goals}.
