...
This can be understood as a recognition by the agent that the specific flight and seat preference mentioned by the traveler are subgoals in a hierarchy below the broader goal of getting to Berlin. 

To show that more structured goals of this type are naturally accommodated by our framework, we designed a simple Hidden Goal collection game inspired by recent work in multi-task reinforcement learning \cite{oh2017zero, andreas2017modular}.
Furthermore, it was 
