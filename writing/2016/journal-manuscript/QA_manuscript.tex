...
% HOW IS OUR MODEL DIFFERENT FROM PAST MODELS
...
The crucial motivation to ask questions in the first place, of course, is an \emph{asymmetry} between questioner and answerer knowledge; agents have private goals and private knowledge about the true state of the world. 
...
When it is the listener's turn to speak, they can then generate statements that address the goal-relevant aspects of the world.
