...
\todo[inline]{Should probably do a `real' model comparison too: when you just look at the posterior over a single coin flip (instead of a coin weight), the `false' option has almost all of the probability mass, indicating that the explicit questioner model is probably better overall than the pragmatic questioner. Not sure how to report this.}
