...
\todo[inline]{Should be < 5 under sentence before}
...
\todo[inline]{can we move the expectation inside the KL?}
\todo[inline]{diagram of partition?}
\todo[inline]{play up novelty of question choice being sensitive to what answerer could say}
...
\ndg{hmm. maybe we should move this example to an appendix, since it doesn't add any conceptual point beyond the clark example (and is complex)?}
