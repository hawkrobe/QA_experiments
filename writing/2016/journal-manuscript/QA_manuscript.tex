...
\abstract{What makes a question useful? What makes an answer helpful?
  ...
  Yet we do not often pose these questions to an impartial oracle; we ask other agents, in dialogue.
  In this paper, we reconcile formal approaches to optimal question-asking and classic psycholinguistic effects of social context by extending recent probabilistic cognitive models of goal-relevant communication to dialogue.
  Agents hear an utterance, update their beliefs through social reasoning, and select an utterance in response.
  The utility of producing a question in this framework is the expected reduction in uncertainty about the aspects of the world relevant to the speaker's goal upon hearing an answer \emph{from their partner.}
  ...
  We compare models of both the questioner and answerer within this framework based on three different pieces of evidence:
