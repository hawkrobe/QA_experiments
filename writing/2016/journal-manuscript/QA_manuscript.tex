...
\todo[inline]{Reformulate this to be clearer about how similar/different they are; currently, it sound like there are a lot of differences -- table might help with this. Seems like core `addition' we needed to model this were richer representations of world states and a larger (potentially infinite) answer space}
%%%%
