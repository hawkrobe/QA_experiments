...
%
$$P(w | q, a) = P(w) \mathds{1}_{\mathcal{P}_q(a)}(w)$$
%
...
The set of answers includes exact prices as well as ``yes'' and ``no'', with an answer prior that prefers ``yes''and ``no'' to the numeric answers.
