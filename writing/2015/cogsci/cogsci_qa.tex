...
\end{center}
\caption{Full space of models, and their correlations with the data from Experiment 1. The questioner models in the first row reason about the answerers directly below them in the top row, and the pragmatic answerer reasons about the explicit questioner.}
