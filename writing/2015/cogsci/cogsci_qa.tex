...
\red{we should make sure in final edits that it touches on key points form the intro.}
...
Doing so require replacing the immediate motive to convey true information with the more distant motive to provoke useful information from one's interlocutor. On the answerer side, sophisticated reasoning was required to account for the implicit interests of the questioner.
\red{a sentence about previous work, e.g. van rooij?}
