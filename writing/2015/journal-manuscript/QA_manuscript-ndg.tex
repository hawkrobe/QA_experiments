...
\hline
&           \% yes/no &   \%  dollar  &           \% yes/no &   \%  dollar    \\
\hline
``Some whiskey'' &   0.41 & 0.59 &  0.37 & 0.62 \\
\hline
``Five dollars''     & 0.50 & 0.50 & 0.50 & 0.50 \\
\end{tabular}
\\[1.5pt]
\caption{Comparison of model predictions and data from Clark (1979)} 
