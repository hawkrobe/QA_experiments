...
\todo[inline]{ndg: I moved this to a new file for post-fyp edits (on our way to a journal paper). We should probably move it to a new dir and change the name appropriately....}
...
\todo[inline]{ndg: I wonder if we should include more intro examples for this longer version? I like this one, but the politeness aspect is slightly misleading....}
...
\todo[inline]{ndg: expand the preceding paragraph to unpack the previous literature on questions a bit more.}
