...
```{r}
d1 = read.csv("versions/experiment1_noMammal/data/q_and_a_nomammal1-trials.tsv",  sep = '\t')
# Remove people who were confused...
ps1 = read.csv("versions/experiment1_noMammal/data/q_and_a_nomammal1-subject_information.tsv", sep = '\t')
...
d2 = read.csv("versions/experiment1_noMammal/data/q_and_a_nomammal2-trials.tsv",  sep = '\t')
ps2 = read.csv("versions/experiment1_noMammal/data/q_and_a_nomammal2-subject_information.tsv", quote = "", sep = '\t')
nonconfused_ps2 <- (ps2 %>% 
                   mutate(asses2 = ifelse(is.na(asses), "None", asses)) %>% 
                   filter(asses2 != 1))$workerid
...
```{r}
times1 = unique(read.csv("versions/experiment1_noMammal/data/q_and_a_nomammal1.tsv", sep = '\t')$Answer.time_in_minutes)
times2 = unique(read.csv("versions/experiment1_noMammal/data/q_and_a_nomammal2.tsv", sep = '\t')$Answer.time_in_minutes)
...
```{r}
pdf("../writing/2015/cogsci/model_fits_grid.pdf")
grid.newpage()
