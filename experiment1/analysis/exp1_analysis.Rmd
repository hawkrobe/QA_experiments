...
```{r}
times1 = unique(read.csv("versions/experiment1/data/q_and_a_nomammal1.tsv", sep = '\t')$Answer.time_in_minutes)
times2 = unique(read.csv("versions/experiment1/data/q_and_a_nomammal2.tsv", sep = '\t')$Answer.time_in_minutes)
